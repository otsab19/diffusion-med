...
class SliceAttention(nn.Module):
    ...
    def forward(self, current_slice, adjacent_slices):
        ...
        adjacent_slices = adjacent_slices.mean(dim=1, keepdim=True)
...
#             other_adj_slices = other_adj_slices.squeeze(2)
        ...
        print(f"Shape after attention on HR, Lr and other slice: {attended_hr.shape} {attended_lr.shape} {attended_other.shape}")
